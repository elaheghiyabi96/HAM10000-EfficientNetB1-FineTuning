# -*- coding: utf-8 -*-
"""EfficientNetB1_augmentation_faradata_71.89%.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1_7RtDZsNmbFplOehFyIcsIk-72fzEPJF
"""
...
IMG_SIZE = 224 # EfficientNetB1 uses 240, but 224 is fine for transfer learning
BATCH_SIZE = 64
NUM_CLASSES = 7
EPOCHS = 40
...
# Preprocessing for EfficientNet remains the same
...
# Start training
print("\nStarting model training with EfficientNetB1...")
history = model.fit(
    train_dataset,
    epochs=EPOCHS,
...
print("\n" + "="*40)
print("     Final Results on the Validation Set (EfficientNetB1)")
print("="*40)
...
# --- Start of the Fine-Tuning Process ---

# The 'base_model' variable should still hold the EfficientNetB1 instance
base_model.trainable = True

# Let's unfreeze the top 30 layers for fine-tuning.
...
print("\nEfficientNetB1 model re-compiled for fine-tuning.")
model.summary()


# Continue training the model to fine-tune it
print("\nStarting fine-tuning for EfficientNetB1...")

fine_tune_epochs = 20
# Set the total number of epochs for the entire process
total_epochs = history.epoch[-1] + 1 + fine_tune_epochs

# We use the same EarlyStopping callback
...
print("\nStarting final evaluation after fine-tuning EfficientNetB1...")
loss, accuracy = model.evaluate(validation_dataset)

print("\n" + "="*40)
print("     Final Results After Fine-Tuning EfficientNetB1")
print("="*40)
print(f"Loss: {loss:.4f}")
print(f"Accuracy: {accuracy * 100:.2f}%")
print("="*40)
...
plt.xlabel('Predicted Label')
plt.ylabel('True Label')
plt.title('Confusion Matrix for Fine-Tuned EfficientNetB1')
plt.show()